...
var workbookSourceId  = '${subscription().id}/resourceGroups/${resourceGroup().name}/providers/microsoft.insights/components/${appinsights_name}'
...
resource data_quality_workbook_resource 'microsoft.insights/workbooks@2018-06-17-preview' = {
  name: workbookId
