...
5. - *Permissions needed*: A Databricks user that has *workspace admin* privileges must create the catalog.
   - *Existing metastore needed*: If a regional metastore does not exist then an account admin must create one. [Metastore Creation](https://learn.microsoft.com/en-us/azure/databricks/data-governance/unity-catalog/create-metastore)
