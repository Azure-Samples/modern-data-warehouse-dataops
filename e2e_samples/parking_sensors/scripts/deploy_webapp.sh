...
#######################################################
# Deploys a zip file for simulating parking data 
#
# Prerequisites:
...
az webapp deploy --clean true --resource-group "$RESOURCE_GROUP_NAME" --name "$APP_NAME" --src-path ./data/data-simulator/data-simulator.zip --type zip --async true --output none
