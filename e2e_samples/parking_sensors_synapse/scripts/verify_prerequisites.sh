...
command -v az devops >/dev/null 2>&1 || { echo >&2 "I require azure cli - devops extension but it's not installed. See https://docs.microsoft.com/en-us/azure/devops/cli/?view=azure-devops. Aborting."; exit 1; }
