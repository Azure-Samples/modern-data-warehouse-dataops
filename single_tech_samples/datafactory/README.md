...
1. **Initial Setup**
   ...
   2. **Import** this repository into a new Github repo. On how to import a github repo. Importing is necessary for setting up git integration with Azure Data Factory.
